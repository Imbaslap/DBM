...
function Moroes:OnCombatStart(delay)
	self:StartStatusBarTimer(35, "Vanish", "Interface\\Icons\\Ability_Vanish");
	self:StartStatusBarTimer(20, "Gouge", "Interface\\Icons\\Ability_Gouge");
	self:ScheduleMethod(20, "SendSync", "Nextgouge");
	self:ScheduleSelf(35, "SoonWarning");
end
...
function Moroes:OnEvent(event, arg1)	
	...
	function Moroes:OnSync(msg)
	if msg == "Nextgouge" then
	self:StartStatusBarTimer(47, "Gouge", "Interface\\Icons\\Ability_Gouge");
	self:ScheduleMethod(47, "SendSync", "Nextgouge");
	end
end
end
