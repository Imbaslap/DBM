...
DBM_TI_YELL_PULL		= "The rituals are about to begin.";
...
DBM_ARAN_YELL_PULL		= "I'll not be tortured again!";
DBM_ARAN_YELL_PULLTWO	= "Who are you? What do you want? Stay away from me!";
DBM_ARAN_YELL_PULLTHREE	= "Please, no more. My son... he's gone mad!";
